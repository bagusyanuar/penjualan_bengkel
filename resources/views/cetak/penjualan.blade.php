...
@section('content')
    <div class="text-center report-title">LAPORAN PENJUALAN</div>
    ...
    <table id="my-table" class="table display" style="margin-top: 10px">
        ...
        <tr>
            ...
            <th width="15%" class="text-center text-body-small">No. Nota</th>
        ...
        @foreach($data as $v)
            <tr>
                ...
                <td class="text-center text-body-small">{{ $v->customer }}</td>
