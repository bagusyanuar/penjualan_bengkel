...
@section('content')
    <div class="text-center report-title">LAPORAN PEMBAYARAN HUTANG</div>
    ...
    <table id="my-table" class="table display" style="margin-top: 10px">
        ...
        <tr>
            ...
            <th width="12%" class="text-center text-body-small">No. Nota</th>
        ...
        @foreach($data as $v)
            <tr>
                ...
                <td class="text-center text-body-small">{{ $v->supplier->nama }}</td>
    ...
    <hr>
    <div class="row">
        <div class="col-xs-9 f-bold text-body-small" style="text-align: right;">Total Pembayaran Hutang :</div>
