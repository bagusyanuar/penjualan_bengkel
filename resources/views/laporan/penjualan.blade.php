...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Laporan Penjualan</p>
...
@section('js')
    ...
    <script>
        var table, tableInfo;
        var path = '{{ route('laporan.penjualan') }}';
        var dataSet = [];
        ...
        $(document).ready(function () {
            ...
            $('#btn-cetak').on('click', function (e) {
                ...
                let tgl1 = $('#tgl1').val();
                let tgl2 = $('#tgl2').val();
                window.open('/laporan/penjualan/cetak?tgl1=' + tgl1 + '&tgl2=' + tgl2, '_blank');
            });
        });
    </script>
@endsection
