...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAddLabel">Tambah Kategori Barang</h5>
                ...
                <div class="modal-body">
                    <div class="w-100 mb-1">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="Nama Kategori Barang"
                               name="nama">
                    </div>
                </div>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="modalEditLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditLabel">Edit Kategori Barang</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    <div class="w-100 mb-1">
                        <label for="nama-edit" class="form-label">Nama Kategori Barang</label>
                        <input type="text" class="form-control" id="nama-edit" placeholder="Nama Kategori Barang"
                               name="nama-edit">
                    </div>
                </div>
                <div class="modal-footer">
